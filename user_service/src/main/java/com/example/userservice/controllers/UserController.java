...
@RestController
@RequestMapping("${app.user-service.path}")
public class UserController implements IUserController {
    ...
    public ResponseEntity<UserReadAndUpdateDto> getUser(@PathVariable Long userId) {
        logger.info("CONTROLLER | getUser() invocation, userId - {}", userId);
    ...
    public void updateUser(@RequestBody UserReadAndUpdateDto dto) {
        logger.info("CONTROLLER | updateUser() invocation, UserReadAndUpdateDto - {}", dto);
