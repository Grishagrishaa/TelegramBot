...
//                        .chatId(chatId)
//                        .replyMarkup(keyboardService.updateKeyboard(chatId))
//                        .build();
    ...
    private BotApiMethod editMessage(Message message, String text, InlineKeyboardMarkup keyboard){
    ...
    public BotApiMethod sendMessage(Long chatId, String text, ReplyKeyboard keyboard){
        return SendMessage.builder()
                .parseMode("HTML")
                .chatId(chatId.toString())
                .replyMarkup(keyboard)
